defmodule Tunez.Music.Album do
  ...
  validations do
    validate numericality(:year_released,
             ...
             message: "Must be between 1950 and the next year"

    validate match(:cover_image_url, ~r"^(https://|/images/).+(\.png|\.jpg)$"),
      where: [changing(:cover_image_url)],
      message: "must start wtih https:// or /images/ and end with .png or .jpg"
  end
  ...
  identities do
    identity :unique_album_names_per_artist, [:name, :artist_id],
      message: "An artist cannot have two albums with the same name"
  end
